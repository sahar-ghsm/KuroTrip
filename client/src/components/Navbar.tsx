...
const blogLinks = [
  { linkName: "All Posts", category: "all" },
  { linkName: "Latest Posts", category: "latest" },
  { linkName: "Javascript", category: "javascript" },
  { linkName: "React", category: "react" },
  { linkName: "Shadow DOM", category: "DOM" },
];
            ...
            <Flex alignItems="center">
              <IconButton
                ...
                icon={
                  <Image
                    h="60px"
                    style={{ borderRadius: "60px", border: "solid 1px black" }}
                    src="../../public/kuroTriplogo.svg"
                  />
                }
                color={logoHover ? "gray.200" : mode("gray.600", "gray.400")}
              />
              <Text fontWeight="extrabold" ml="10px" color={mode("gray.600", "gray.400")}>
                Kuro Trip
              </Text>
            </Flex>
          </Link>
